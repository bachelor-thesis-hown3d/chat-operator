...
# quay.io/hown3d/chat-operator-bundle:$VERSION and quay.io/hown3d/chat-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/hown3d/chat-operator
...
teardown: ## Delete created kind cluster
